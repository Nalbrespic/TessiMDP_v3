 ...
 * Trackings
 *
 * @ORM\Table(name="trackings", uniqueConstraints={@ORM\UniqueConstraint(name="Exapass", columns={"numCompteExp", "numColis"})}, indexes={@ORM\Index(name="numLigne", columns={"numLigne"})})
 * @ORM\Entity
 */
class Trackings
{
