...
// * EcommAppli
// *
// * @ORM\Table(name="ecomm_appli", uniqueConstraints={@ORM\UniqueConstraint(name="FileName", columns={"AppliName"})}, indexes={@ORM\Index(name="idClient", columns={"idClient"})})
...
//     * @var string
//     *
//     * @ORM\Column(name="AppliNameRef", type="text", length=255, nullable=false)
//     */
...
//     * @var string
//     *
//     * @ORM\Column(name="dossierImg", type="string", length=128, nullable=false)
//     */
//    private $dossierimg;
//
//    /**
//     * @var boolean
//     *
//     * @ORM\Column(name="gpmnttrans", type="boolean", nullable=false)
//     */
//    private $gpmnttrans = '0';
//
//    /**
//     * @var integer
//     *
...
//     * @var string
//     *
//     * @ORM\Column(name="codeAppli", type="string", length=10, nullable=false)
//     */
//    private $codeAppli;
//
//    /**
...
//
//    /**
//     * @param String $appliImage
//     */
//    public function setAppliImage($appliImage)
//    {
//        $this->appliImage = $appliImage;
//    }
//
//
//
