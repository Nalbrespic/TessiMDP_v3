        ...
        self.$el.find('li[data-lz-index=\'' + index + '\'] > h3 > a.arrow-btn').each(function() {
            if (action === 'toggle') {
                ...
                if ($(this).hasClass('expanded')) {
                    console.log("fffffffffffffffffffeeee")
                    var eltm = $(this).parent().parent().find(' > ul');
                    eltm.attr('style', 'z-index: -10;background-color: #504a62;border-radius: 5px;margin-top: -26px;padding-top: 4px;padding-bottom: 12px;margin-left: 4px;box-shadow: 4px 2px 7px gray;margin-bottom: 7px;');
                    var eltm1 = $(this).parent().parent().find(' > ul > span');
                    eltm1.attr('style', 'display:block;');
                    ...
                    var eltm = $(this).parent().parent().find(' > ul');
                    eltm.attr('style', 'z-index: 20;background-color: #504a62;border-radius: 5px;margin-top: -26px;padding-top: 4px;padding-bottom: 12px;margin-left: 4px;box-shadow: 4px 2px 7px gray;margin-bottom: 7px;');
                    var eltm1 = $(this).parent().parent().find(' > ul > span');
                    eltm1.attr('style', 'display:none;');
